...
function r_show_pagination(){
  ...
  echo "<ul class='pager small-block-grid-7'>";
  $first_link_icon = "<i class='fa fa-angle-double-left'></i>";
  if($start_page_link > 0){
    echo "<li><a href='" . get_pagenum_link(1) . "'>" . $first_link_icon ."</a></li>";
  } else {
    echo "<li class='disabled'>" . $first_link_icon . "</li>";
  }
  $prev_link_icon = "<i class='fa fa-angle-left'></i>";
  if($current_page > 1){
    echo "<li><a href='" . get_pagenum_link($current_page-1) . "'>" . $prev_link_icon . "</a></li>";
  } else {
    echo "<li class='disabled'>" . $prev_link_icon . "</li>";
  }
  ...
  $next_link_icon = "<i class='fa fa-angle-right'></i>";
  if($current_page < $max_page){
    echo "<li><a href='" . get_pagenum_link($current_page+1) . "'>" . $next_link_icon . "</a></li>";
  } else {
    echo "<li class='disabled'>" . $next_link_icon . "</li>";
  }
  $last_link_icon = "<i class='fa fa-angle-double-right'></i>";
  if($end_page_link+1 < $max_page){
    echo "<li><a href='" . get_pagenum_link($max_page) . "'>" . $last_link_icon . "</a></li>";
  } else {
    echo "<li class='disabled'>" . $last_link_icon . "</li>";
  }
  echo "</ul>";
}
