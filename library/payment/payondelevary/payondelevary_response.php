<?php /*ee92719cf7ec6b0f354cf4e5759683bf*/ ?>
<?php /*?><form name="frm_payment_method" id="frm_payment_method" action="<?php echo get_option('siteurl'); ?>/?page=payment&paymentmethod=<?php echo $_POST['paymentmethod'];?>" method="post">
<table>
