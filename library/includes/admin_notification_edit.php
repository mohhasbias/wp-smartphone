...
if($file_array)
{
  ...
  <tr>
  <td>Message : </td>
  <td><textarea name="message" cols="50" rows="8"><?php echo $file_array['message'];?></textarea></td>
  </tr>
  <tr>
  <td></td>
  <td><input type="submit" name="Submit" value="Submit"> <input type="button" name="cancel" value="Cancel" onClick="window.location.href='<?php echo get_option('siteurl');?>/wp-admin/admin.php?page=notification'">
  <input type="button" name="cancel" value="Back" onClick="window.location.href='<?php echo get_option('siteurl');?>/wp-admin/admin.php?page=notification'">
  </td>
  </tr>
</table>
</form>
