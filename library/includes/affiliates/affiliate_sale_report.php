...
<div id="page" class="clearfix">
	...
	if($user_affiliate_data)
	{
		...
		foreach($user_affiliate_data as $key => $val)
		{
			...
			?>
				...
				<td align="right" class="row1" ><?php echo number_format($val['order_amt'],2);?></td>
				<td align="center" class="row1" ><?php echo $currency[1];?></td>
				<td align="right" class="row1" ><?php echo number_format($share_amt,2);?></td>
			</tr>   
			<?php
				}			
			}			
	...
	{
	?>
    <tr><td colspan="8"> <h4> Not record available. </h4> </td></tr>
    <?php
	}else
	{
	?>
    <tr><td  colspan="3" class="row1">&nbsp;</td>
    <td align="right" class="row1"><b><?php _e('Total');?></b></td><td align="center" class="row1" ><b><?php echo $product_qty;?></b></td><td align="right" class="row1" ><b><?php echo number_format($total_order_amt,2);?></b></td><td align="right" class="row1" >&nbsp;</td><td align="right" class="row1" ><b><?php echo number_format($share_total,2);?></b></td></tr>
    <tr>
