...
<table width="100%" class="table">
    ...
    <tr>
        ...
        <td class="row1" ><?php echo number_format($user_total_array[1],2).' '.$General->get_currency_code();?></td>
	</tr>
    <tr>
        <td class="row1" >Your Total Earning : </td>
        <td class="row1" ><?php echo number_format($user_total_array[0],2).' '.$General->get_currency_code();?></td>
	</tr>
     <tr>
...
function ajax_set_affiliate_account()
{
	...
	$.ajax({
		url: '<?php echo get_option('siteurl'); ?>/?page=account&'+dataString,
		type: 'GET',
		dataType: 'html',
		timeout: 9000,
		error: function(){
