...
if($_GET['ptype']=='prd' || $_POST || $editproduct==1){
	...
	array(
		...
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "For this particular product, if you want to disable your shopping cart and want to take your visitor to some other website (for example an affiliate link to Amazon.com), mention the full URL here and Buy Now button will appear on your site that will take the user to new site ");
