<?php /*d4f61fee330db5e980dccaac209079af*/ ?>
<?php
...
foreach ($posts_columns as $column_name=>$column_display_name) {
	...
	case 'title':
		?>
		<td><strong><a class="row-title" href="../includes/page.php?action=edit&post=<?php the_ID(); ?>" title="<?php echo attribute_escape(sprintf(__('Edit "%s"'), $title)); ?>"><?php echo $pad; echo $title ?></a></strong>
	...
	case 'author':
		?>
		<td><a href="../includes/edit-pages.php?author=<?php the_author_ID(); ?>"><?php the_author() ?></a></td>
		<?php
		break;
...
<?php endif; ?>
    ...
    <?php endif; ?>
    <a href="../includes/edit-comments.php?s=<?php comment_author_IP() ?>&mode=detail"><?php comment_author_IP() ?></a>
