...
$twitter_id = '@murahgrosir';
$facebook = 'murahgrosircom';
$googleplus = 'murahgrosircom';
$instagram = 'murahgrosir';

?>

<ul class="rrssb-buttons clearfix">
    <li class="facebook">
        <a href="https://www.facebook.com/<?php echo $facebook; ?>" class="">
            <span class="icon">
    ...
    <li class="twitter">
        <a href="http://twitter.com/<?php echo $twitter_id; ?>" class="">
            <span class="icon">
    ...
    <li class="googleplus">
        <a href="https://plus.google.com/<?php echo $googleplus; ?>" class="">
            <span class="icon">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    <g>
                        <g>
    ...
    <li class="instagram">
        <a href="http://instagram.com/<?php echo $instagram; ?>">
        <span class="icon">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
