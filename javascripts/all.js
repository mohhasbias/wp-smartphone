  ...
  var settings = {
    ...
    methods = {
      ...
      reposition : function (target, tip, classes) {
        ...
        objPos(tip, (target.offset().top + target.outerHeight() + 10 - 15 ), 'auto', 'auto', target.offset().left, width);
        ...
        if(!hasHover(p)) {
          ...
          if (li.hasClass('active')) {
            ...
            flyout.slideUp('fast', function() {
              flyout.parent('li').removeClass('active');
            });
            // p.find('li').removeClass('active').end().find('.content').slideUp();
          } else {
            console.log('inactive');
            // $('.content', p).not(flyout).slideUp().parent('li').removeClass('active');
...
;(function ($, window, undefined) {
  ...
  $.fn.foundationNavigation = function (options) {
    ...
    if (Modernizr.touch || navigator.userAgent.match(/Windows Phone/i)) {
      ...
      $('.nav-bar>li.has-flyout', this).on('activate deactivate', function (e) {
        if (e.type == 'activate') {
